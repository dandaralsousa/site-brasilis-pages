...
const Footer = () => {
    ...
    <div className="footer">
        ...
        <a href="https://www.facebook.com/brasilisagencia/" target="_blank">     
            <img className="imgs" src={Img1} alt="Imagem do logo do Facebook" width="25px" height="25px"/>

        </a>

        <a href="https://www.instagram.com/agenciabrasilis/" target="_blank">     
            <img className="imgs"src={Img2} alt="Imagem do logo do Instagram" width="25px" height="25px"/>

        </a>

        <a href="https://www.linkedin.com/in/agência-brasilis-comunicação-805565150/" target="_blank">       
        ...
        <p>Desenvolvido por <a href="https://www.linkedin.com/in/dandarasousa/" target="_blank"><strong>Dandara Sousa</strong></a>. Todos os direitos revervados.</p>
        </div>
